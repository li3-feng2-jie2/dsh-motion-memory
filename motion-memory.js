...
export function apply(ctx) {
  ...
  // （已拆至 ../motion-memory-modules/time-utils.mjs：pad/nowIso/parts/ymdPath/ymPath/
  //   isEventRel/stamp/ymdCompact/parseIso/uid——顶层 import 引入）
  ...
  // ── 记忆文件对象 ───────────────────────────────────────────────────────
  // （已拆至 ../motion-memory-modules/memory-objects.mjs：histEntry/turnRefOfMeta/
  //   newKeywordObj/sanitizeFile/eventFileName——顶层 import 同名引入）
